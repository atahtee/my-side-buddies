          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage(destination.asset), fit: BoxFit.cover),
            ),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Expanded(child: Column(
                      ...
                      children: [
                        Text(
                          destination.name, style: Theme.of(context).textTheme.headlineMedium,
                        ),
                        ...
                        Row(
                          children: [
                            Wrap(
                              spacing: -24,
                              children: destination.testimonials.map((e) => Container(
                                height: 40,
                                width: 40,
                                decoration: BoxDecoration(
                                  border: Border.all(
                            ...
                            const SizedBox(width: 8,),
                            TextButton(onPressed: (){}, child: Text("See what they had to say"))
                          ],
                        )
                      ],
                     )
                ...
                Text(destination.headline, style: Theme.of(context).textTheme.titleMedium,),
                const SizedBox(height: 16,),
                Text(destination.desc , style: Theme.of(context).textTheme.bodyMedium,),
              ],
            ),
          )),
