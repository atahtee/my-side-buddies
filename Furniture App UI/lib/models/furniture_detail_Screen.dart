...
import 'package:furniture/models/home/furniture_model.dart';

class FurnitureDetailScreen extends StatefulWidget {
  const FurnitureDetailScreen({super.key});

  @override
  State<FurnitureDetailScreen> createState() =>  _DetailFurnitureScreenState();
}

class _DetailFurnitureScreenState extends State<FurnitureDetailScreen> {
